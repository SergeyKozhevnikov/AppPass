...
function TabPanel(props: TabPanelProps) {
    const { children, value, index, isAdaptive = false, ...other } = props;

    // Стили для адаптивного и неадаптивного режимов
    ...
    return (
        <div
            ...
            hidden={value !== index}
            id={`tabpanel-${index}`}
            style={isAdaptive ? adaptiveStyles : regularStyles}
            {...other}
        >
          ...
          <Card sx={{ width: '100%', margin: '0 auto' }}>
            ...
            {/* Содержимое таба "Очереди согласования" */}
              <TabPanel value={tabValue} index={1}>
                  {/*<Box sx={{ width: 1200, display: "flex", justifyContent: "center", alignItems: "center"}}/>*/}
                  ...
                  <Grid container size={12} spacing={2}>
                      ...
                      <Grid size={3} justifyContent="right" alignItems="right">
                          <Button
                              variant="contained"
                              color="primary"
                              onClick={() => setOpen(true)}>Добавить согласующего</Button>
                      </Grid>
                  </Grid>
            ...
            <TabPanel value={tabValue} index={2}>
              <Box sx={{ width: 1200, minHeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
